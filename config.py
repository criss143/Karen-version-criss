# ConfiguraciÃ³n Ãºnica de KAREN â€” edita aquÃ­ tus datos personales
import os
...
# ---------- VOZ (boca) ----------
# Dalia: femenina mexicana neural, cÃ¡lida (estilo Karen)
VOZ = "es-MX-DaliaNeural"
VOLUMEN = 1.0
# Prosodia natural, no robÃ³tica
VOZ_RATE = "+8%"
VOZ_PITCH = "+1Hz"
VOZ_VOLUME = "+0%"
...
MODELO_STT = "base"            # base=rÃ¡pido+espaÃ±ol decente | small=mÃ¡s preciso y lento
...
SOLO_POR_PALABRA = True        # True: mic en REPOSO hasta oÃ­r "Karen"

# ---------- CEREBRO (LLM) ----------
# Local gratis (siempre): Ollama qwen3:8b con think=false (rÃ¡pido)
MODELO_LLM = "qwen3:8b"
OLLAMA_URL = "http://127.0.0.1:11434"
USAR_OLLAMA = True
# APIs cloud (gratis / Pro). Prioridad: env â†’ secrets.json â†’ aquÃ­.
...
def _key(*vals) -> str:
    """Primera key real; ignora vacÃ­os y placeholders tipo pega_aqui."""
...
# Anthropic (Claude) â€” deja vacÃ­o si aÃºn no tienes clave; la secciÃ³n degrada sola.
# ConsÃ­guela en https://console.anthropic.com y pÃ©gala en secrets.json -> "ANTHROPIC_API_KEY"
...
# Preferencia por defecto de cada secciÃ³n ("auto" = cadena por defecto)
SECCION_LLM = {
    "codigo": "claude",
    "creativo": "claude",
    "mundo": "groq",
...
SNR_MIN = 3.0             # seÃ±al/ruido mÃ­nimo para aceptar la captura (evita ruido de fondo)
NO_SPEECH_MAX = 0.35      # faster-whisper: descarta segmentos con no_speech_prob >= esto
AVG_LOGPROB_MIN = -0.55   # log-prob media del segmento: muy negativa = alucinaciÃ³n forzada
...
# ---------- LUCES LED BLE ----------
TIRA_BLE_ADDR = ""             # se rellena automÃ¡ticamente al parear tu tira
TIRA_BLE_NOMBRES = ("LEDBLE", "LED BLE", "Zengge", "Magic Light", "LEDnet",
                    "Fenix", "Light", "BT-LED", "HM-", "LAMPLED", "XXX")

# ---------- MONITOREO DE WEBS ----------
SITIOS = [
    # "https://tudominio.com",   â† aÃ±ade aquÃ­ tus pÃ¡ginas y descomenta
]
INTERVALO_MONITOREO = 300      # segundos entre revisiones de tus webs
LIMITE_LENTO_MS = 2000         # mÃ¡s de esto = "web lenta"
